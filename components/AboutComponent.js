        ...
        const renderLeader = ({item, index}) => {
            ...
            if(this.props.leaders.isLoading){
                return(
                    <ScrollView>
                        <History />
                        <Card title='Corporate Leadership' style={{flex: 1}}><Loading/></Card>
                    </ScrollView>   
                )
                ...
                return(
                    <ScrollView>
                        <History />
                        <Card title='Corporate Leadership' style={{flex: 1}}><Text>{this.props.leaders.errMess}</Text></Card>
                    </ScrollView>   
                )
            } else{
            return(
                    <ScrollView>
                        <History />
                        <Card title='Corporate Leadership' style={{flex: 1}}>
                            <FlatList
